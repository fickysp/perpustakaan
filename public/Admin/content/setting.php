...
if (isset($_POST['simpan'])) {
    ...
    if (mysqli_num_rows($querySetting) > 0) {
        ...
        //update
        $update = mysqli_query($koneksi, "UPDATE setting SET email_website='$email_website', no_tlpn_website='$tlp_website', alamat_website='$alamat_website',
        fb='$facebook_link', twitter='$twitter_link', ig='$instagram_link', linkedin='$linked_link' WHERE id='1' ");
...
<form action="" method="post" enctype="multipart/form-data">
    ...
    <div class="mb-3">
        ...
        <textarea class="form-control" name="alamat_website" id=""><?php echo $rowSetting['alamat_website'] ?></textarea>
    </div>
    <div class="mb-3">
